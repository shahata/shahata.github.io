(function () {
  /* global document, alert, setTimeout, localStorage, window */
  'use strict';

  var mines, width, height;
  var game, guesses, initGame, superman, nodes;
  ...
  window.superman = superman = function () {
  ...
  window.initGame = initGame = function (loadedGame) {
